...
for proyecto in os.listdir(ROOT_DIR):
    ruta_proyecto = os.path.join(ROOT_DIR, proyecto)
...
ruta_salida = os.path.join(ROOT_DIR, "hipervolumen_summary.csv")
...
if archivos_invalidos:
    ...
    ruta_invalidos = os.path.join(ROOT_DIR, "archivos_invalidos.csv")
