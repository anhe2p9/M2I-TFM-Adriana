...
| `-a`, `--algorithm`    | Algorithm to use for solving single and multiobjective ILP problems. Must be one of: `['ObtainResultsAlgorithm', 'WeightedSumAlgorithm2obj', 'WeightedSumAlgorithm', 'EpsilonConstraintAlgorithm2obj', 'HybridMethodForThreeObj']`. |
...
| `-w`, `--weights`      | Specific weights for weighted sum: `w1,w2` or `w1,w2,w3`.                                                                                                                                                                           |
| `-o`, `--objectives`   | Objectives to minimize: `obj1,obj2` or `obj1,obj2,obj3`.                                                                                                                                                                            |
