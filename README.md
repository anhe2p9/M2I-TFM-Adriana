...
| `-a`, `--algorithm`    | Algorithm to use for solving multi-objective problems. Must be one of: `['ObtainResultsAlgorithm', 'WeightedSumAlgorithm2obj', 'WeightedSumAlgorithm', 'EpsilonConstraintAlgorithm2obj', 'HybridMethodForThreeObj']`.|
