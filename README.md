...
| `-a`, `--algorithm`         | Algorithm to use for solving single and multiobjective ILP problems. Must be one of: `['ObtainResultsAlgorithm', 'WeightedSumAlgorithm', 'EpsilonConstraintAlgorithm', 'HybridMethodForThreeObj']`. |
